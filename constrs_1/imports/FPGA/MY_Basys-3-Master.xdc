...
# set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { i_digit_position[0] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
# set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { i_digit_position[1] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
...
set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { o_select_position[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=DP
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { o_select_position[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=DP
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { o_select_position[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=DP
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { o_select_position[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=DP
...
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { i_digit_position[0] }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports { i_digit_position[1] }]; #IO_L5P_T0_AD13P_35    ,Sch=JA8
